...
save=$ROOT/$PREFIX game=elfgames.go.game model=df_kl model_file=elfgames.go.df_model3 python3 -u train.py --mode train --server_id $PREFIX --batchsize 8 --num_games 32 --keys_in_reply V --num_block 10 --T 1 --num_minibatch 10 --num_episode 1000000 \
